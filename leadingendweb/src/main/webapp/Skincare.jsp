...
<head lang="en">
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" type="text/css" href="css1/Skincare.css"/>
	 ...
	 <div class="fnav">
	 	...
	 	<div class="fnav2">
	 		...
	 		<div class="gation1">
	 			...
	 			<p>
	 				按护肤系列查看悦诗风吟的商品
	 				<span><img src="img/l2.gif"/>
	 				<img src="img/l1.gif"/>
	 				<img src="img/q3.gif"/></span>
	 			</p>
	 		</div>
	 		<div class="gation2">
				<c:forEach items="${skincar}" var="s">
					<a href="skincareproductAll?id=${s.skincareProductId}">
	 			<div class="img1" >
	 				<img src="${s.iconclass}"/>
	 				<p class="zt">${s.name}</p>
	 			</div>
	 			...
	 			<div class="gend">
					<c:forEach items="${skincarAll}" var="s">
						<a href="skincareproductAll?id=${s.skincareProductId}">
					<p class="zt">
	 					${s.name}
	 				</p>
			...
			<form class="form-horizontal bucket-form" action="Condition1" method="post">
				<div class="gation4">
					<div class="effect">
						功效
					</div>
			...
			<div class="gation6">
					<form class="form-horizontal" role="form">
				         ...
				         <p><input type="button" class="form-control" onclick="search()" value="搜索" ></p>
				   </form>
				   <div class="products">
